...
high-energy human may be annoyed if their dog is not up for their desi2 activities. 
...
Hugarian algoritym (aka the Huhn-Munkres algorithym). This package wraps the C++
code written by Cong Ma in the [hungarian-algoritym-cpp](https://github.com/mcximing/hungarian-algorithm-cpp/blob/master/Hungarian.h) library on GitHub. I have wrapped/edited that code in such a way that 
the algoritym can be used either through the R interface `HungarianSolver` or
